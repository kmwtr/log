...
def log_assets_processor():
    ...
    image_lists_dict['thumbnail_image_list'].sort(reverse=True)
    ...
    # サムネイルリストを走査
    for file_name in image_lists_dict['thumbnail_image_list']:
    ...
    # ファイルリストを走査
    for file_name in image_lists_dict['source_image_list']:
    ...
    tmpl = env.get_template('log_page_template.html')
